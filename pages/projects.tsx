            ...
            >
              ...
              >
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white shadow-inner">
                  ...
                  />
                  <div
                    className={`pointer-events-none absolute inset-0 bg-gradient-to-t ${project.glow} opacity-0 transition-opacity duration-500 group-hover/preview:opacity-100`}
                  />
                </div>
              </a>
