...
function ContactHeroSvg() {
  return (
    ...
    >
      <defs>
        <linearGradient id="contact-flap" x1="40" y1="60" x2="240" y2="130" gradientUnits="userSpaceOnUse">
      ...
      {/* Soft glow */}
      <ellipse cx="140" cy="115" rx="95" ry="55" className="fill-blue-500/10 dark:fill-blue-500/5" />
      {/* Envelope body */}
      <rect
        x="45"
        y="65"
      ...
      <path
        d="M45 65L140 125L235 65H45z"
        fill="url(#contact-flap)"
      />
      <path
      ...
      <rect
        ...
        strokeWidth="1"
      />
      <line x1="78" y1="105" x2="182" y2="105" className="stroke-slate-200 dark:stroke-slate-500" strokeWidth="1" strokeLinecap="round" />
      <line x1="78" y1="115" x2="165" y2="115" className="stroke-slate-200 dark:stroke-slate-500" strokeWidth="1" strokeLinecap="round" />
      <line x1="78" y1="125" x2="152" y2="125" className="stroke-slate-200 dark:stroke-slate-500" strokeWidth="1" strokeLinecap="round" />
      {/* Checkmark badge */}
      <circle cx="208" cy="122" r="24" className="fill-blue-500/25 dark:fill-blue-500/30 stroke-blue-500/60 dark:stroke-blue-400/60" strokeWidth="1.5" />
      <path d="M199 122l6 6 14-14" className="stroke-blue-600 dark:stroke-blue-400" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10 flex-1">
          <div className="max-w-4xl mx-auto grid lg:grid-cols-5 lg:gap-12 lg:items-stretch">
            ...
            >
              ...
              <div className="hidden lg:block flex-1 min-h-[1.5rem]" aria-hidden />
              <motion.div
