...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    description:
      "I work as a Full Stack Software Engineer who uses AI to orchestrate coding agents and ship the right product. With the help of AI, I design, architect, and implement features end-to-end, focusing on user value, scalability, and clarity rather than just writing code. AI augments how I think and build so I can move faster from idea to production without sacrificing quality or design.",
  },
];
